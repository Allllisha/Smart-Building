...
INSERT INTO projects (
    ...
    true,     -- 中高層条例：有
    false,    -- 盛土規制法：無
    '【設計概要】大成ユーレック株式会社による白山1丁目共同住宅計画。RC造5階建、全18戸（2LDK×13戸、3LDK×5戸）。敷地面積472.16㎡、建築面積285.64㎡、延床面積1,285.64㎡。建ぺい率60%、容積率300%。日影規制対象（測定面GL+1.5m、冬至日8-16時）。【注意事項】敷地の面積・形状・方位については実測要。計画建物内容は未定で変更可能性あり。作成日：2025年5月12日、設計：大成ユーレック株式会社、図面番号：6304103'
);
